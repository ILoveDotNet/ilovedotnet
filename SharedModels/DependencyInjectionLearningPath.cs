    ...
    public DependencyInjectionLearningPath()
    {
        ...
        new(2)
        {
            new ContentMetaData
            {
                ...
                Author = "Abdul Rahman",
                PosterUrl = "image/blogs/dependency-injection/introducing-dependency-injection-in-dotnet.png",
                ThumbnailUrl = "image/blogs/dependency-injection/introducing-dependency-injection-in-dotnet.png",
            ...
            new ContentMetaData
            {
                ...
                Author = "Abdul Rahman",
                PosterUrl = "image/blogs/dependency-injection/dependency-injection-lifetimes-in-dotnet.png",
                ThumbnailUrl = "image/blogs/dependency-injection/dependency-injection-lifetimes-in-dotnet.png",
