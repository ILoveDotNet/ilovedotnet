...
public class Achievements
{
  ...
  public Achievements()
  {
    ...
    [
        ...
        new() { Date = new DateOnly(2024, 12, 31), Impressions = 58900 },
        new() { Date = new DateOnly(2025, 1, 31), Impressions = 56700 },
        new() { Date = new DateOnly(2025, 2, 28), Impressions = 59400 },
        new() { Date = new DateOnly(2025, 3, 31), Impressions = 67200 },
        new() { Date = new DateOnly(2025, 4, 30), Impressions = 58800 },
        new() { Date = new DateOnly(2025, 5, 31), Impressions = 60200 },
        new() { Date = new DateOnly(2025, 6, 30), Impressions = 58000 },
        new() { Date = new DateOnly(2025, 7, 31), Impressions = 61400 },
        new() { Date = new DateOnly(2025, 8, 31), Impressions = 54500 },
        new() { Date = new DateOnly(2025, 9, 30), Impressions = 40300 },
        new() { Date = new DateOnly(2025, 10, 31), Impressions = 34500 },
        new() { Date = new DateOnly(2025, 11, 30), Impressions = 29800 },
        new() { Date = new DateOnly(2025, 12, 31), Impressions = 27400 },
        new() { Date = new DateOnly(2026, 1, 31), Impressions = 50700 },
        new() { Date = new DateOnly(2026, 2, 28), Impressions = 54600 },
        new() { Date = new DateOnly(2026, 3, 31), Impressions = 48200 },
        new() { Date = new DateOnly(2026, 4, 30), Impressions = 58800 },
        new() { Date = new DateOnly(2026, 5, 31), Impressions = 73100 },
    ];
  }
}
