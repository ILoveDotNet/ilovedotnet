...
public class TableOfContents
{
  ...
  private readonly List<ContentMetaData> _fullContents = new(222);
  ...
  public TableOfContents()
  {
    ...
    _fullContents.AddRange(new CachingLearningPath().FullContents);
    _fullContents.AddRange(new DatabaseLearningPath().FullContents);
    _fullContents.AddRange(new DDDLearningPath().FullContents);
    ...
    _fullContents.AddRange(new EFCoreLearningPath().FullContents);
    ...
    _fullContents.AddRange(new MemoryLearningPath().FullContents);
    _fullContents.AddRange(new MiddlewareLearningPath().FullContents);
    _fullContents.AddRange(new NugetLearningPath().FullContents);
